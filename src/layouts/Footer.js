...
function Footer() {
  ...
  return (
    <footer id="footer">
      <div className="relative flex flex-col space-y-10 bg-zinc-700 px-5 py-8 font-Dana text-gray-300 md:space-y-11 md:pt-16 md:pb-11">
        {/* دکمه */}

        <div className="absolute inset-x-0 -top-2.5 z-20 hidden h-15 md:block xl:-top-4 2xl:-top-5.5">
          <div className="absolute -top-13.75 left-1/2 size-21 -translate-x-1/2 rounded-full bg-gray-100 dark:bg-zinc-800" />

          <svg
            className="absolute top-0 left-0 h-15 w-full"
      ...
      "
          ...
          <button
            className="absolute -top-3.5 left-1/2 flex size-7.5 -translate-x-1/2 cursor-pointer items-center justify-center rounded-full border-2 border-orange-300 bg-gray-100 dark:bg-zinc-700"
            onClick={upHandler}
          >
            <span className="size-5 text-zinc-700 dark:text-white">
              {chevronUp}
            </span>
          </button>
        </div>
        ...
        <div className="flex flex-col xl:items-center xl:justify-center xl:text-xl 2xl:flex-row">
          <div>
            ...
            <p className="mt-6 text-justify text-lg text-gray-300 md:mt-4.5 xl:max-w-221 xl:text-xl/12 2xl:max-w-146">
          ...
          <div className="mt-10 md:mt-4 xl:flex xl:gap-x-12">
            <div className="mt-8 2xl:mr-12">
              <h3 className="text-2xl/7 font-semibold text-white">
                {" "}
                دسترسی سریع{" "}
              </h3>

              <div className="mt-6 flex items-center gap-x-10 md:mt-7 xl:gap-x-16">
            ...
            <div className="mt-12 md:mt-8">
              <h3 className="mb-7 text-2xl/7 font-semibold text-white">
                {" "}
                در تماس باشیم{" "}
              </h3>
              <div className="mt-5 space-y-4 xl:space-y-5">
              ...
              <div className="mt-6 flex gap-x-1.5 md:mt-10 md:gap-x-6 md:text-xl">
                <Link
                  href="#"
                ...
                >
                  {/* Gradient */}
                  <span className="absolute inset-0 z-0 bg-linear-to-r from-orange-200 to-orange-300 opacity-0 transition-opacity duration-1000 ease-in-out group-hover:opacity-100" />

                  {/* Content */}
                  <span className="relative z-0 size-6 text-orange-300 transition-colors duration-1000 group-hover:text-zinc-700 md:size-9">
                    <svg
                      width="39"
                      height="38"
                      viewBox="0 0 39 38"
                  ...
                  <span
                    className="relative z-0 mt-0.75 transition-colors duration-1000 group-hover:text-zinc-700"
                    dir="ltr"
                  >
                    @golden_coffee
                  </span>
        ...
        <p className="mx-auto h-px w-99/100 bg-paleWhite xl:w-279 2xl:w-full 2xl:max-w-386.5">
          {" "}
        </p>

        <div className="flex flex-col font-Dana text-xs/5 font-medium md:text-base xl:items-center xl:justify-between xl:text-xl/12">
            ...
            <div className="flex size-7.5 shrink-0 items-center justify-center">
              <span className="flex size-full items-center justify-center rounded-full border border-paleWhite">
                <span className="flex size-5 items-center justify-center rounded-full border border-[#FFFFFF33]">
                  <span className="block size-2.5 rounded-full bg-linear-to-b from-orange-300 to-orange-200"></span>
                </span>
              </span>
            </div>
